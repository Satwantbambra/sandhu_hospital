  ...
  return (
    <div>
        <div className="container-fluid px-0 about space pb-0">
          <div className="container space " style={{background:"#f5f5f5", borderRadius:10, border:"1px solid #eaeaea"}}>
            <h1 className='banner-black text-lg-center'>
            Learn <span style={{color:" var(--pink)"}}>More</span> About <span style={{color: " var(--neon)"}}>Us</span>
            </h1>
          ...
          <div className="row">
            <div className="col-lg-5">
              ...
              >
                ...
                Together, We {" "}
                  <span style={{ color: "var(--neon)" }}>Strive</span> for Excellence  in  {" "}
        ...
        <div className="col-lg-4">
           <div className="team-card">
            ...
            <div className="col-6">
              ...
              With over 15 years of experience in cardiology,
               Dr. Aarav raj Sharma has dedicated his career to diagnosing and treating various heart conditions.
              </p>
