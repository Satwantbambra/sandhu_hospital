...
class Index extends React.Component {
  ...
  fetchPromotions() {
    ...
    axios
      ...
      .catch((error) => {
        console.error(
          "There was an error fetching the promotional banner!",
          error
        );
      });
  }
                ...
                <div className="row">
                  {this.state.banners && this.state.banners.length > 0 ? (
                    this.state.banners.map((banner, index) => {
                      ...
                      const className =
                        bannerClasses[index % bannerClasses.length];
                      return (
                        <div className="col-xl my-2" key={`banner-${index}`}>
                          <div className={`${className} promotion`}>
                            ...
                            <div className="h-100 d-flex align-items-end">
                              <p
                                className="sub-heading-white dateText mb-1"
                                style={{
                                  color: "var(--blue)",
                      ...
                      <div className="col-xl my-2">
                        <div className="bluepromotion promotion">
                          <button
                            ...
                            aria-label="Close"
                          ></button>
                          <h2 className="p-white-bold">
                            {this.state.banners[0].text1}
                          </h2>
                          <h3 className="section-heading-white">
                            {this.state.banners[0].text2}
                          </h3>
                          <h4 className="sub-heading-white">
                            {this.state.banners[0].text3}
                          </h4>
                          <h5 className="p-white">
                            {this.state.banners[0].text4}
                          </h5>
                          <div className="h-100 d-flex align-items-end">
                            <p className="sub-heading-white mb-1">
                              {this.state.banners[0].time_period}
                            </p>
                          </div>
                        </div>
                      </div>
              ...
              <div className="row">
                <div className="col-lg-5">
                  ...
                  >
                    <h3 className="section-heading-black my-0">
                      ...
                      Family,{" "}
                      <span style={{ color: "var(--pink)" }}>Every Life</span>{" "}
                      is Precious
                    </h3>
                  </div>
                </div>
                <div className="col-lg-7">
                  <p className="p-black my-0">
                    At Sandhu Hospital, Nawanshahar, we are dedicated to
                    providing exceptional healthcare across a wide range of
                    specialties. As a MultiSpeciality Hospital,Our compassionate
                    and highly skilled medical team ensures that every patient
                    receives personalized, quality care in a comforting
                    environment. At Sandhu Hospital, your health is our
                    priority. we are proud to offer expert care in:
                  </p>
                </div>
              </div>
              ...
              <div className="row my-2 py-3">
                {this.state.services.length > 0 ? (
                  this.state.services.map((service, index) => (
                    <div
                      key={`services-${index}`}
                      className="services-contain col-lg-3 mb-3 "
                    >
                      <Link
                        to={
                          service?.beautify === "1"
                            ? `/skin/${service.id}#${service.name.replace(
                                /\s+/g,
                                "-"
                              )}`
                            : `/service/${service.id}#${service.name.replace(
                                /\s+/g,
                                "-"
                              )}`
                        }
                      >
                        ...
                        <div className="service-t mt-3">
                          ...
                          <div
                            ...
                            className="p-black my-0 overflow-2"
                          ></div>
                        </div>
                      </Link>
                    </div>
                        ...
                        <div className="d-flex align-items-start justify-content-between flex-column">
                          ...
                          <div className="s1">
                            ...
                            <div className="mt-3">
                              ...
                              <p className="p-grey">
                                With advanced technology and a team of
                                world-class neurologists, we lead the field in
                                brain health. Our focus is on innovative
                                treatment options and personalized care plans
                                that prioritize your well-being and long-term
                                brain health.
                              </p>
                            </div>
                          </div>
              ...
              <div className="row">
                <div className="col-lg-6 mb-lg-0 mb-5">
                  ...
                  <p className="p-black mt-4">
                    ...
                    conditions, cosmetology, and advanced LASER procedures. It
                    is also renowned for its expertise in medicine, chest
                    diseases, and general & laparoscopic surgery. Equipped with
                    a state-of-the-art laboratory, an advanced medical I.C.U.,
                    and round-the-clock emergency services, Sandhu Hospital
                    ensures top-quality care and treatment for patients in a
                ...
                {this.state.subservices.length > 0 ? (
                  this.state.subservices.map((subservice, index) => {
                    ...
                    if (index % 4 < 2) {
                      ...
                      return (
                        <div
                          key={`subservices-${index}`}
                          className="services-contain col-lg-6 mb-3"
                        >
                          <div className="row">
                            ...
                            <div className="col-lg-6">
                              <div className="cwt1">
                                ...
                                <p className="p-black overflow-3 mt-0 mb-2">
                                  {" "}
                                  {subservice.description.replace(
                                    /<\/?[^>]+(>|$)/g,
                                    ""
                                  )}
                                </p>
              ...
              <div className="row">
                <div className="col-lg-5">
                  <h3 className="section-heading-black ">
                    Stories of{" "}
                    <span style={{ color: "var(--pink)" }}>Healing,</span>{" "}
                    <br /> Voices of{" "}
                    <span style={{ color: "var(--neon)" }}>Trust</span>
                  </h3>
                </div>
                <div className="col-lg-7">
                  <p className="p-black mb-0">
                  ...
                  this.state.testimonials.map((testimonial, index) => (
                    ...
                    >
                      <div className="testimonial">
                        ...
                        <p className="p-black">{testimonial.message}</p>
