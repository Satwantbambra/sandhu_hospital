...
export default function Index(props) {
  ...
  return (
    <div data-bs-spy="scroll" data-bs-target="#navbar-sticky" data-bs-offset="0" className="scrollspy-example" tabIndex="0" ref={scrollSpyRef}>
        ...
        <div className="banner">
            <div className="container">
                ...
                <div className="row" style={{height: '100%'}}>
                    <div className=" col-lg-7 col-11 d-flex align-items-center" style={{height: '100%'}}>
                        <div className="fade-text" ref={fadeTextRef}>
                            <span className="word animated fadeIn banner-white">Dedicated</span>
                            <span className="word animated fadeIn banner-white">to</span>
                            <span className="word animated fadeIn banner-white">Your</span>
                            <span className="word animated fadeIn banner-white">Health,</span>
                            <br/>
                            <span className="word animated fadeIn banner-white">Committed</span>
                            <span className="word animated fadeIn banner-white">to</span>
                            <span className="word animated fadeIn banner-white">Your</span>
                            <span className="word animated fadeIn banner-white">Future</span> 
                        </div>
                    </div>
                </div>
        ...
        <div className="container">
                ...
                <div className="col-lg-5">
                    <div className=" d-flex align-items-center" style={{height: '100%'}}>
                        ...
                        <h3 className="section-heading-black my-0">
                            Where Every <span style={{color: 'var(--neon)'}}>Patient</span> is Family, <span style={{color: 'var(--pink)'}}>Every Life</span> is Precious
                        </h3>
                    </div>
                </div>
                <div className="col-lg-7">
                    <p className="p-black my-0">
                        At Sandhu Hospital, Nawanshahar, we are dedicated to providing exceptional healthcare across a
                        wide range of specialties. As a MultiSpeciality Hospital,Our compassionate and highly skilled
                        medical team ensures that every patient receives personalized, quality care in a comforting
                        environment. At Sandhu Hospital, your health is our priority. we are proud to offer expert care
                        in:
                    </p>
            ...
            <div className="row my-2 py-3">
                <div className="services-contain col-lg-3 mb-3 mb-lg-0">
                    ...
                    <div className="service-t mt-3">
                        ...
                        <p className="p-black my-0 overflow-2">
                            Advanced treatments for neurological disorders and brain health.
                        </p>
                ...
                <div className="services-contain col-lg-3 mb-3 mb-lg-0">
                    ...
                    <div className="service-t mt-3">
                        <h2 className="p-heading-black mt-0 mb-2">
                            De-addiction
                        </h2>
                        <p className="p-black my-0 overflow-2">
                            Comprehensive programs to help individuals overcome substance abuse.
                        </p>
                ...
                <div className="services-contain col-lg-3 mb-3 mb-lg-0">
                    ...
                    <div className="service-t mt-3">
                        ...
                        <p className="p-black my-0 overflow-2">
                            State-of-the-art skincare, cosmetic treatments, and LASER therapy.
                        </p>
                ...
                <div className="services-contain col-lg-3 mb-3 mb-lg-0">
                    ...
                    <div className="service-t mt-3">
                        ...
                        <p className="p-black my-0 overflow-2">
                            Specialized care for respiratory and internal medicine conditions.
                        </p>
                    ...
                    <div className="white-to-blue " >
                        <div className="row">
                                ...
                                <div className="d-flex align-items-start justify-content-between flex-column">
                                    ...
                                    <div className="s1">
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <p className="p-grey">
                                                With advanced technology and a team of world-class neurologists, we lead
                                                the field in brain health. Our focus is on innovative treatment options
                                                and personalized care plans that prioritize your well-being and
                            ...
                            <div className="col-lg-8">
                                <div className="mains">
                                    <div className="mimg ">
                                        <img src={bbrain} alt="sandhu hospital"
            ...
            <div className="row mt-3">
                <div className="col-lg-3  mb-3 mb-0">
                    ...
                    <div className="cwt1">
                        ...
                        <p className="p-blue-small my-0 overflow-2" style={{textAlign: 'justify'}}>
                            Including stroke, epilepsy, Parkinson’s disease, dementia, and neurological conditions.
                        </p>

                        <h3 className="p-black-bold mt-2 mb-1">How We Cure:</h3>
                        <p className="p-black overflow-3 mt-0 mb-2">
                            We use Advanced diagnostics, medications, neurorehabilitation, and minimally invasive
                            surgery.
                        </p>
                ...
                <div className="col-lg-3  mb-3 mb-0">
                    ...
                    <div className="cwt1">
                        ...
                        <h3 className="p-black-bold mt-2 mb-1">How We Cure:</h3>
                        <p className="p-black overflow-3 mt-0 mb-2">
                            Medical detox, counseling, behavioral therapy, and long-term rehabilitation.
                        </p>
            ...
            <div className="row mt-3">
                ...
                <div className="col-lg-3  mb-3 mb-0 ">
                    <div className="cwt1">
                        ...
                        <p className="p-blue-small my-0 overflow-2" style={{textAlign: 'justify'}}>
                            Acne, eczema, psoriasis, fungal infections,Wrinkles, scars, pigmentation, hair loss.
                        </p>

                        <h3 className="p-black-bold mt-2 mb-1">How We Cure:</h3>
                        <p className="p-black overflow-3 mt-0 mb-2">
                            Topical treatments, medications, Cosmetic procedures and LASER treatments for rejuvenation
                            and hair removal.
                ...
                <div className="col-lg-3   mb-2 mb-0">
                    ...
                    <div className="cwt1">
                        ...
                        <p className="p-blue-small my-0 overflow-2" style={{textAlign: 'justify'}}>
                            Pneumonia,Pulmonary Fibrosi, Asthma, bronchitis, pneumonia, COPD.,Emphysema
                        </p>

                        <h3 className="p-black-bold mt-2 mb-1">How We Cure:</h3>
                        <p className="p-black overflow-3 mt-0 mb-2">
                            We provide tailored treatments that include medications, inhalation therapy, pulmonary
                            rehabilitation, oxygen therapy, and in severe cases, advanced interventions like mechanical
